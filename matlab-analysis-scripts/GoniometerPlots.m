...
%% Reduce specular reflection intensity 5-fold
thetaSpecular = ((theta<=2.5)&(theta>=-2.5));
AA(thetaSpecular,:) = AA(thetaSpecular,:)/6;
...
cLims = [0 0.7E-4];%[0 0.85E-4]; % set colour scale limits
...
yTick = 300:100:700;%flip(1./((300:100:700).*1E-9));
